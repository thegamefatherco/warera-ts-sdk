...
* [getByTypeAndEntity](#getbytypeandentity) - Get upgrade by type and entity
...
import { upgradesGetByTypeAndEntity } from "@thegamefatherco/warera-sdk/funcs/upgradesGetByTypeAndEntity.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("upgradesGetByTypeAndEntity failed:", res.error);
  }
}
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.UpgradeGetUpgradeByTypeAndEntityRequest](../../models/operations/upgradegetupgradebytypeandentityrequest.md)                                                       | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
