...
* [getByCountryId](#getbycountryid) - Get government by country ID
...
import { governmentsGetByCountryId } from "@thegamefatherco/warera-sdk/funcs/governmentsGetByCountryId.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("governmentsGetByCountryId failed:", res.error);
  }
}
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.GovernmentGetByCountryIdRequest](../../models/operations/governmentgetbycountryidrequest.md)                                                                       | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
