 ...
 */
export function battleRankingsGet(
  client: WareraCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.BattleRankingGetRankingRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/battleRanking.getRanking")();
  ...
  const context = {
    ...
    operationID: "battleRanking.getRanking",
    oAuth2Scopes: null,
