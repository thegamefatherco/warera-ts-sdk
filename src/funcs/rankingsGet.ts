...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.RankingGetRankingRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/ranking.getRanking")();
  ...
  const context = {
    ...
    operationID: "ranking.getRanking",
    oAuth2Scopes: null,
