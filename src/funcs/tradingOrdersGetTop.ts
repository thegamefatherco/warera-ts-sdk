 ...
 */
export function tradingOrdersGetTop(
  client: WareraCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.TradingOrderGetTopOrdersRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/tradingOrder.getTopOrders")();
  ...
  const context = {
    ...
    operationID: "tradingOrder.getTopOrders",
    oAuth2Scopes: null,
