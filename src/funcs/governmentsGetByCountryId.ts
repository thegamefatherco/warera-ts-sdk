 ...
 */
export function governmentsGetByCountryId(
  client: WareraCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GovernmentGetByCountryIdRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/government.getByCountryId")();
  ...
  const context = {
    ...
    operationID: "government.getByCountryId",
    oAuth2Scopes: null,
